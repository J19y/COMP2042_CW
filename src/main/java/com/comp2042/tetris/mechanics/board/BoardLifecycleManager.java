...
public class BoardLifecycleManager implements BoardLifecycle {
    ...
    public void newGame() {
        ...
        com.comp2042.tetris.domain.model.SpawnResult result = new com.comp2042.tetris.mechanics.spawn.BrickSpawn() {
            @Override
            public com.comp2042.tetris.domain.model.SpawnResult spawnBrick() {
                com.comp2042.tetris.mechanics.bricks.Brick currentBrick = boardState.getBrickGenerator().getBrick();
