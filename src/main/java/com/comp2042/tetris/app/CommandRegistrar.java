...
public class CommandRegistrar {
    ...
    public void registerDefaultCommands(BrickMove moveHandler, BrickDrop dropHandler, BrickDropActions dropActions,
                                        ScoringPolicy scoringPolicy, ScoreManager scoreService, SpawnManager spawnManager,
                                        BoardRead reader, GameView view) {
